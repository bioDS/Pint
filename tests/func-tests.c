...
static void test_update_beta_cyclic(UpdateFixture *fixture, gconstpointer user_data) {
	printf("beta[27]: %f\n", fixture->beta[27]);
	update_beta_cyclic(fixture->X, fixture->Y, fixture->rowsum, fixture->n, fixture->p, fixture->lambda, fixture->beta, fixture->k, fixture->dBMax, fixture->intercept, 0, NULL);
	printf("beta[27]: %f\n", fixture->beta[27]);
...
static void test_simple_coordinate_descent_main(UpdateFixture *fixture, gconstpointer user_data) {
	...
	fixture->X = fixture->xmatrix.X;
	fixture->beta = simple_coordinate_descent_lasso(fixture->X, fixture->Y, fixture->n, fixture->xmatrix.actual_cols, fixture->lambda, "cyclic", 10, 0, 0);
...
static void test_simple_coordinate_descent_int(UpdateFixture *fixture, gconstpointer user_data) {
	...
	fixture->beta = simple_coordinate_descent_lasso(fixture->X, fixture->Y, fixture->n, fixture->xmatrix.actual_cols, fixture->lambda, "cyclic", 10, 1, 0);
