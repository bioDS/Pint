...
static void test_always_succeeds() { g_assert(1 == 1); }

static void test_always_fails() { g_assert(1 == 2); }

// will fail if Y has been normalised
static void test_can_read_Y()
{
    float* Y = read_y_csv("/home/kieran/work/lasso_testing/testYSmall.csv", 1000);
