...
if (length(args >= 2)) {
  ...
  f <- "../xyz-simulation/simulated_data/n10000_p1000_SNR2_nbi0_nbij200_nlethals0_viol0_89257.rds"
...
result <- pairwise_lasso(X, Y, lambda_min = 0.04, max_interaction_distance=-1, use_adaptive_calibration=TRUE, max_nz_beta=-1, verbose=TRUE)
